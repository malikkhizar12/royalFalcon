                    ...
                    Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Image.asset('images/rides_cover.png',width: MediaQuery.of(context).size.width,),
                        ),
                              ...
                              Row(
                                ...
                                children: [
                                   Padding(
                                     ...
                                     child: Text("Best Sellings",style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 20.sp
                                                                       ),
                                     ),
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    return Container(
                                      ...
                                      width: 250.w, // adjust the width of your list items
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          StarRating(rating: 4, size: 20, color: Color(0xFFFF9A3E)), // Static star rating
                                          Padding(
